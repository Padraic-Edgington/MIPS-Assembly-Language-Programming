...
fibonacci:
		...
		li		$t0, 0			#  Fibonacci(n-2)
		li		$t1, 1			#  Fibonacci(n-1)
		
		li		$t3, 2
fib_loop:
		bgt		$t3, $a0, end_loop
		
		add		$t2, $t1, $t0	#  Fibonacci(n)
		move	$t0, $t1
		move	$t1, $t2
...
#############################################################################################
		...
		.data
test1:	.asciiz	"Testing Fibonacci(0) = 0.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test2:	.asciiz	"Testing Fibonacci(1) = 1.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test3:	.asciiz	"Testing Fibonacci(2) = 1.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test4:	.asciiz	"Testing Fibonacci(3) = 2.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test5:	.asciiz	"Testing Fibonacci(4) = 3.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test6:	.asciiz	"Testing Fibonacci(5) = 5.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test7:	.asciiz	"Testing Fibonacci(6) = 8.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test8:	.asciiz	"Testing Fibonacci(7) = 13.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test9:	.asciiz	"Testing Fibonacci(8) = 21.\n"
		.text
		...
		jal		Assert_Equal_Integer
		.data
test10:	.asciiz	"Testing Fibonacci(9) = 34.\n"
		.text
