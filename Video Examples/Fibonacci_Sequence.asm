Fibonacci:
		...
		li			$t0, 2					#  n
loop:	bgt			$t0, $a0, finished

		sll			$t1, $t0, 2
		add			$t1, $t1, $v0			#  Location of F(n-1)
...
test2b:	.asciiz	"Fibonacci(1) = [0, 1]"
		...
		.data
test3a:	.word	3, 0, 1, 1
test3b:	.asciiz	"Fibonacci(2) = 0, 1, 1"
		.text
		...
		jal		Assert_Equal_Array
		.data
test4a:	.word	4, 0, 1, 1, 2
test4b:	.asciiz	"Fibonacci(3) = 0, 1, 1, 2"
		.text
		...
		jal		Assert_Equal_Array
		.data
test5a:	.word	5, 0, 1, 1, 2, 3
test5b:	.asciiz	"Fibonacci(4) = 0, 1, 1, 2, 3"
		.text
		...
		jal		Assert_Equal_Array
		.data
test6a:	.word	6, 0, 1, 1, 2, 3, 5
test6b:	.asciiz	"Fibonacci(5) = 0, 1, 1, 2, 3, 5"
		.text
		...
		jal		Assert_Equal_Array
		.data
test7a:	.word	7, 0, 1, 1, 2, 3, 5, 8
test7b:	.asciiz	"Fibonacci(6) = 0, 1, 1, 2, 3, 5, 8"
		.text
